...
//=============================  Define Defines  ============================
//===========================================================================
#if MAX_EXTRUDERS > 1 && defined TEMP_SENSOR_1_AS_REDUNDANT
  #error "You cannot use TEMP_SENSOR_1_AS_REDUNDANT if MAX_EXTRUDERS > 1"
#endif

#if MAX_EXTRUDERS > 1 && defined HEATERS_PARALLEL
  #error "You cannot use HEATERS_PARALLEL if MAX_EXTRUDERS > 1"
#endif
